...
import com.android.snowproject.ui.apicall.GetLog;
...
public class AllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlStr2 = "https://kbxxyomk13.execute-api.ap-northeast-2.amazonaws.com/prod/devices/SnowProject/log";
        ...
        startDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(AllActivity.this, callbackMethod, 2020, 12, 0);
