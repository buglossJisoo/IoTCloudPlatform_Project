...
void connectMQTT() {
  ...
  mqttClient.subscribe("$aws/things/SnowProject/shadow/update/delta");
}
...
void getDeviceStatus(char* payload) {
  ...
  //const char* addr = "경기도 고양시 일산서구 덕산로121번길 37";
...
void sendMessage(char* payload) {
  // 자신의 aws 사물 이름으로 알맞게 변경 필수
  char TOPIC_NAME[]= "$aws/things/SnowProject/shadow/update";
